...
export const dialogueData = {
  ...
  // J
  'johnny': `This is the free ${createLink(urls.johnny, 'Johnny')} server! He's <a href="${createLink(urls.tipsForJohnny)}" target="_blank" rel="noopener noreferrer">incredibly popular</a> since he hosts all of HelioHost's free accounts!`,
  ...
  'lily': `This is ${createLink(urls.lily, 'Lily')}! She's pretty special because she runs Windows Server!`,
  ...
  'morty': `This is the ${createLink(urls.morty, 'Morty')} server! He's HelioHost's flagship server, offering ${createLink(urls.mortySignup, 'unlimited memory usage and unlimited CPU usage')}! Morty is fast. Like... super fast.<p>How fast can you blink? Yeah, he's much faster than that.`,
