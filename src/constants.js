...
export const dialogueData = {
  ...
  'potion-storage': "Whoever left all this stuff on the floor clearly needs a better storage solution.<p>If I ever need more than the <a href='https://wiki.helionet.org/Storage' target='_blank'>1000 MB of disk space</a> that comes with my standard HelioHost account, I can make a <a href='https://wiki.helionet.org/Donations_for_Increased_Storage' target='_blank'>one-time donation</a> to add more storage, increasing my filespace up to a total of 6000 MB. That would hold so many memes...",
  ...
  'table-terms': "These are HelioHost's <a href='https://heliohost.org/terms/' target='_blank'>Terms of Service</a>! I better check this out to make sure I don't break any rules and get my <a href='https://wiki.helionet.org/Suspension_Policy' target='_blank'>account suspended</a>.",
  'table-wiki': "HelioHost has a <a href='https://wiki.helionet.org/' target='_blank'>Wiki</a>, too?! Awesome!<p>I bet other folks have asked the same questions I have. I guess I'll find my answers in the <a href='https://wiki.helionet.org/FAQ' target='_blank'>FAQ</a> section!<p>First up: figuring out what 'FAQ' even means...<p>Then I'll build something cool with the help of their <a href='https://wiki.helionet.org/Tutorials' target='_blank'>tutorials</a>!",
