...
export const dialogueData = {
  ...
  // G
  'ghost': `Did you know that all HelioHost staff are  ${createLink(urls.eta, 'volunteers')}?! Yup, they help users for free in their spare time! <p>When I have free time, I go camping. Oh, I'm not a ghost, I just got tangled up in my bedsheets. Ha ha! I'm really stuck here...`,
  ...
  // H
  'hello-world-left': `'HELLO WORLD', the classic starting point for every new creation! <p>HelioHost offers a ${createLink(urls.createWebsite, 'quick guide')} for getting a basic website set up inside Plesk!`,
  'hello-world-right': `'HELLO WORLD', that's what I'm going to name my app! <p>Hmm... What programming language should I build it with?<p>I'll check out HelioHost's ${createLink(urls.tutorials, 'tutorials')} for some inspiration!`,
  ...
  // M
  'maze': `<div style="transform: rotate(180deg); display: inline-block;">... This place is a-maze-ing! I am a little bit dizzy...</div>`,
  ...
  // T
  'table-database': `I love tables. At HelioHost, we can create ${createLink(urls.postgresql, 'PostgreSQL')}, ${createLink(urls.mariadb, 'MySQL / MariaDB')}, and ${createLink(urls.sqlite, 'SQLite')} databases.<p>Did you know that 'SQL' is actually pronounced 'SQL', not 'SQL'?! So many people say it wrong!`,
